		...
		if v1 == '' or v1 == '0' then
			...
			doTweenAlpha('fadingov','ov',1,v1)
				...
				if getProperty('gf.visible') or getProperty('gf.alpha') > 0 and not getProperty('stageData.hide_girlfriend') then
					runHaxeCode([[
        			    		FlxTween.tween(game.gf, { alpha: 0.0001 }, ]]..v1..[[);
    					]])
					doTweenAlpha("frontStuffDIE", "front", 0.001, v1, "")
					doTweenAlpha("bgBYE", "bg", 0, v1, "")
				end
          	else
			...
			doTweenAlpha('fadingov','ov',0.0001,v1)
				...
				if getProperty('gf.visible') or getProperty('gf.alpha') > 0 and not getProperty('stageData.hide_girlfriend') then
					runHaxeCode([[
        			    		FlxTween.tween(game.gf, { alpha: 1 }, ]]..v1..[[);
    					]])
					    doTweenAlpha("frontStuffDIE", "front", 1, v1, "")
					    doTweenAlpha("bgHI", "bg", 1, v1, "")
				end
          	end
